...
if fl is not None:
    ...
    os.chdir(r"C:\Users\khush\Searches\Downloads\workss")
...
num_dates = len(df1)
random_indices = np.random.choice(num_dates, size=5, replace=False)
...
plt.xticks(ticks=random_indices, labels=["" for _ in random_indices])  
